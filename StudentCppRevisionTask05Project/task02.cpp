...
bool task02(int number) {
	return number < 10000 && number >= 0 &&
		(number < 10 || number > 9 && number < 100 && number / 10 == number % 10 
			|| number>99 && number < 1000 && number / 100 == number % 10
			|| number > 999 && number < 10000 && number / 1000 == number % 10 && number / 100 % 10 == number / 10 % 10);
}
